...
int main( int argc, char** argv )
{
  ...
  else // flag_breakdown == true
  {
    ...
    for(auto it = map_obsch_subhistos.begin(); it!= map_obsch_subhistos.end(); it++){
        ...
        if (flag_move == 1){
            legend[obschannel-1]->SetX1NDC(0.15); // New x1 position
            legend[obschannel-1]->SetX2NDC(0.65); // New x2 position
            legend[obschannel-1]->SetY1NDC(0.7); // New y1 position
            legend[obschannel-1]->SetY2NDC(0.92); // New y2 position
        }
        ...
        legend[obschannel-1]->AddEntry(hext, Form("Cosmic Data, %.1f", hext->Integral()), "F");
        ...
        legend[obschannel-1]->AddEntry(houtFV, Form("Dirt/out FV, %.1f", houtFV->Integral()), "F");
        ...
        legend[obschannel-1]->AddEntry(hnumuCCinFV, Form("Other in FV, %.1f", hnumuCCinFV->Integral()), "F");
